# Generated by Django 5.1.4 on 2024-12-28 23:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.TextField(help_text='Enter a book genre (e.g. Science fiction, French Poetry etc. )', max_length=200, unique=True)),
            ],
            options={
